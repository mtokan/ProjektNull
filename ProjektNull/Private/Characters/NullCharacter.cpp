...
void ANullCharacter::Equip()
{
	...
	else
	{
		...
		{
			PlayEquipMontage(FName("Holster"));
...
void ANullCharacter::PlayEquipMontage(FName SectionName)
{
...
void ANullCharacter::FinishEquipping()
{
	ActionState = EActionState::EAS_Unoccupied;
}
